    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      <div className="card p-6 sm:p-8 space-y-5 text-sm text-surface-700">
        ...
        <section className="space-y-1">
          ...
          <p>- Wartelisten-Daten (Name, E-Mail, Einwilligungen, DOI-Status, technische Metadaten)</p>
          <p>- Technische Daten (z. B. IP/Logdaten bei Hosting)</p>
        </section>
        <section className="space-y-1">
          <p className="font-semibold text-surface-900">Double-Opt-In für Warteliste</p>
          <p>
            Für Wartelisten-Einträge versenden wir eine Bestätigungs-E-Mail. Erst nach Klick auf den DOI-Link wird die Anmeldung
            als bestätigt gespeichert.
          </p>
        </section>
        <section className="space-y-1">
          <p className="font-semibold text-surface-900">AI-Verarbeitung (Simulation)</p>
          <p>Für AI-Dialoge werden simulative, minimierte Falldaten an einen AI-Dienst übermittelt (OpenAI via Supabase Edge Functions).</p>
        ...
        <section className="space-y-1">
          ...
          <p>- E-Mail-Versand (Warteliste/Einladungen): Resend</p>
        </section>
        <section className="space-y-1">
