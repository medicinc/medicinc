  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="card p-6 sm:p-8 space-y-3">
        ...
        <p className="text-sm text-surface-700">Meldungen können in der App eingereicht werden. Inhalte werden geprüft und bei Verstößen eingeschränkt oder entfernt.</p>
        <p className="text-sm text-surface-700">Wiederholte Verstöße können zur Account-Sperrung führen.</p>
      </div>
    </div>
  )
}
